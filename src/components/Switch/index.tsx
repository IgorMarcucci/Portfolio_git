...
export default function Switch() {
    ...
    const [isDarkMode, setIsDarkMode] = useState<boolean>(localStorage.getItem("themeMode") === "dark" ? true : false);

    useEffect(() => {
        dispatch(setTheme(isDarkMode === true ? "dark" : "light"));
    ...
    return (
        <div className="my-dark-mode-switch">
        <svg display="none">
        ...
        <label className="switch scale-110 md:scale-150">
            <input
            ...
            />
            <svg
            className={`switch__icon ${isDarkMode ? 'switch__icon--active' : ''}`}
            width="24px"
            height="24px"
            aria-hidden="true"
            >
